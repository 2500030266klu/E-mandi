...
function generateReceiptHtml({ txnId, date, farmerName, farmerId, buyer, commodity, qty, rate, amount, status, language = 'en' }) {
...
module.exports = { generateReceiptHtml, receiptTranslations };
